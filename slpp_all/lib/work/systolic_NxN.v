module systolic_NxN #(parameter N = 4)(
    ...
    // lookahead     for each MAC[i][j]:
    // next_a = a_wire one position right, or next_a_in at edge
    // next_b = b_wire one position down, or next_b_in at edge
    generate
