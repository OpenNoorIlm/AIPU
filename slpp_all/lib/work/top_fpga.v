...
module top_fpga(
    ...
    output uart_tx_pin // T13     to FTDI RX
);
    ...
    // startup sequencer     wait ~2 seconds (54M cycles) before firing
    // gives ESP32 Serial2 time to initialize and not miss UART output
