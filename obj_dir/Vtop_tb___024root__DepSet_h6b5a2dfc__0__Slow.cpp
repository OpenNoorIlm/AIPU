...
#endif
            VL_FATAL_MT("top_tb.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtop_tb___024root___dump_triggers__act(Vtop_tb___024root* vlSelf) {
    ...
    if ((2ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge top_tb.reset)\n");
    }
...
VL_ATTR_COLD void Vtop_tb___024root___dump_triggers__nba(Vtop_tb___024root* vlSelf) {
    ...
    if ((2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge top_tb.reset)\n");
    }
...
VL_ATTR_COLD void Vtop_tb___024root___ctor_var_reset(Vtop_tb___024root* vlSelf) {
    ...
    vlSelf->top_tb__DOT__task_id = VL_RAND_RESET_I(8);
    vlSelf->top_tb__DOT__task_cycles = VL_RAND_RESET_I(32);
    ...
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->top_tb__DOT__dut__DOT__disp__DOT__q_cycles[__Vi0] = VL_RAND_RESET_I(32);
    }
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
    ...
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 2; ++__Vi1) {
            vlSelf->top_tb__DOT__dut__DOT__disp__DOT__chain_timer[__Vi0][__Vi1] = VL_RAND_RESET_I(32);
        }
    }
    vlSelf->__Vtrigprevexpr___TOP__top_tb__DOT__clk__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigprevexpr___TOP__top_tb__DOT__reset__0 = VL_RAND_RESET_I(1);
}
